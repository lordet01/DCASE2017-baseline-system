function [aspectrum,wts] = audspecXinhui(pspectrum, sr, nfilts, fbtype, minfreq, maxfreq, sumpower, bwidth, params)
...
elseif strcmp(fbtype, 'mel')
  wts = fft2melmxXinhui(nfft, sr, nfilts, bwidth, minfreq, maxfreq, params);
