...
dir_Basis = 'dict'; mkdir(dir_Basis);
...
VAD_set = [0 0 0];
run_dictionary_train(dir_Basis, DB_path_list, DC_freq_set, VAD_set, EVENT_NUM, B_class_event_full, 'mel', p);
run_dictionary_train(dir_Basis, DB_path_list, DC_freq_set, VAD_set, EVENT_NUM, B_class_event_full, 'lin', p);
...
% % DC_freq_set = [80];
% % VAD_set = [0];
% % run_dictionary_train(dir_Basis, DB_path_list, DC_freq_set, VAD_set, 1, B_class_event_full, 'mel', p);
% % % run_dictionary_train(dir_Basis, DB_path_list, DC_freq_set, VAD_set, 1, B_class_event_full, 'lin', p);
